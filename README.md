...
<strong>	2.</strong> Criar as CLASSES: Bootcamp, Cursos, Mentorias e Devs e depois relaciona-las <br>
<strong>	3.</strong> As CLASSES Curso, Mentoria e Devs também estão MODELADOS, ou seja, com seus ATRIBUTOS E MÉTODOS criados <br> 
<strong>	4.</strong> Para que o código fique mais legível e de fácil manutenção, foi utilizado algumas ferramentas que o PARADIGMA DE ORIENTAÇÃO A OBJETOS (POO) nos oferece: ABSTRAÇÃO, ENCAPSULAMENTO, HERANÇA E POLIMORFISMO <br>
